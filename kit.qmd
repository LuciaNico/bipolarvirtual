...
This has left other challenges experienced by them, including risk-taking and decision-making, largely unresolved. To address this issue, we are creating a personalised recovery and resilience kit using the metaphors to organise its content. The development of the kit is informed by findings in past and current studies, and co-design methodology.
...
\[1:1 carers, family, friends; Community support/self-help groups; 'Official' groups offered by government or health-service authorities\]
...
\[Take a look at https://www.thedecider.org.uk\]
...
\[Perhaps comment on Advance Statements or Decisions; Self-management training\]
