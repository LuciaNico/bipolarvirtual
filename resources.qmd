...
The Virtual Allotment builds on the principles of [The Personalised Recovery and Resilience Kit (PeRRK)](kit.qmd). Within this space, you can also explore the visual and written depiction of the [pagoda, used here as a metaphor for mental wellness](pagoda_closeread.qmd), as well the [PeRRK for Parenting](PeRRK_parenting.qmd), and the [PeRRK for University Students](PeRRK_students.qmd).
